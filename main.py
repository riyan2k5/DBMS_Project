...
def get_firebase_db_url(json_path):
    """Extract database URL from Firebase credentials file"""
    try:
        with open(json_path, 'r') as f:
            key_data = json.load(f)
        project_id = key_data.get('project_id')

        # Your specific project URL with correct region
...
def backup_all_tables_to_firebase():
    ...
    try:
        ...
        # Updated queries to match your actual database schema
        tables_to_backup = {
...
class AdminApp(QWidget):
    ...
    def init_ui(self):
        ...
        view_layout.addWidget(self.backup_btn)  # Add backup button to layout
